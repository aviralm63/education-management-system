                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $video->id }}">
                        ...
                        <td width="40%" class="text-center">
                            @if($video->video)
                            <iframe id="video1" width="300" height="170" src="{{ $video->video->getUrl() }}" frameborder="0" allowtransparency="true" allowfullscreen></iframe>
                            @endif 
                        </td>
                        <td>
                            {{ $video->title ?? '' }}
...
<script>
    $(function() {
        ...
        let table = $('.datatable-Video:not(.ajaxTable)').DataTable({
            buttons: dtButtons
        })
